...
var linx = new Object();
linx["What's New"] = "$/whatsnew.htm";
linx["What's Next"] = "$/whatsnext.htm";
linx["Site Map"] = "$/sitemap.htm";
linx["A-Z Index"] = "$/azindex.htm";
linx["Careers"] = "$/careers/default.htm";
linx["RSS Feeds"] = "$/feeds/default.htm";
linx["All Videos"] = "$/mediacenter/media.htm";
linx["Current FAQs"] = "$/faqs/faq.htm";
